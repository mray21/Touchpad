...
import com.thingstuff.touchpad.R;
...
public class Touchpad extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        key_shift.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
        ...
        key_ctrl.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton button, boolean checked) {
        ...
        key_alt.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton button, boolean checked) {
        ...
        View play = media.findViewById(R.id.play);
        ...
        if (to == null)
            touchpad.setImageResource(R.mipmap.background_bad);
    }
    ...
    CompoundButton.OnCheckedChangeListener mButton0ToggleListener = new CompoundButton.OnCheckedChangeListener() {
        public void onCheckedChanged(CompoundButton cb, boolean on) {
            if (on) sendDown(0);
            else sendUp(0);
        }
    };
    View.OnLongClickListener mButton0ClickListener = new View.OnLongClickListener() {
    ...
    CompoundButton.OnCheckedChangeListener mButton1ToggleListener = new CompoundButton.OnCheckedChangeListener() {
        public void onCheckedChanged(CompoundButton cb, boolean on) {
            if (on) sendDown(1);
            else sendUp(1);
        }
    };
    View.OnLongClickListener mButton1ClickListener = new View.OnLongClickListener() {
        public boolean onLongClick(View arg0) {
            if (button[1].isChecked())
                button[1].toggle();
            sendClick(1);
    ...
    // Keyboard listener.
    View.OnClickListener mKeyboardListener = new View.OnClickListener() {
    ...
    protected boolean connect(final String to, int password, boolean reconnect) {
        ...
        try {
            ...
            touchpad.setImageResource(R.mipmap.background);
